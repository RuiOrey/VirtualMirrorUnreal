Shader "Skin/PreIntegratedSkinShaderSM5" {
	Properties {
		...
		_BumpinessDR ("Diffuse Bumpiness R", Float) = 0.48
		_BumpinessDG ("Diffuse Bumpiness G", Float) = 0.41
		_BumpinessDB ("Diffuse Bumpiness B", Float) = 0.28
		_BumpMap ("Normal Map", 2D) = "bump" {}
		_SpecGlosDepthMap ("Specular (R) Glosiness(G) Depth (B)", 2D) = "white" {}
		_Bumpiness ("Specular Bumpiness", Float) = 0.9
		_SpecIntensity ("Specular Intensity", Float) = .1
		_SpecRoughness ("Specular Roughness", Float) = 0.7
